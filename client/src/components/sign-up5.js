          ...
          <div className="sign-up5-form">
            <div className="sign-up5-title-root">
              <h2 className="sign-up5-text10 thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="sign-up5-text18">Create an account</span>
                  </Fragment>
                )}
              </h2>
            ...
            <div className="sign-up5-container3">
              ...
              <button className="sign-up5-button2 thq-button-outline">
                ...
                <span className="thq-body-small">
                  {props.action3 ?? (
                    <Fragment>
                      <span className="sign-up5-text21">
            ...
            <button className="sign-up5-button3 thq-button-filled">
              <span className="sign-up5-text15 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-up5-text17">Sign up with email</span>
                  </Fragment>
                )}
              </span>
            </button>
...
SignUp5.defaultProps = {
  ...
  content1: undefined,
  image1Src:
    'https://images.unsplash.com/photo-1534437219548-8e3fddf45143?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzc5NDE5NXw&ixlib=rb-4.0.3&q=80&w=1080',
  action2: undefined,
  action3: undefined,
}
